    ...
    <!-- Common Banner Area -->
    <section id="common_banner" style="background-image: url('<?php echo base_url(); ?>assets/img/banner/common-banner.png');">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about_us_right">
                        <img src="<?php echo base_url(); ?>assets/img/comon/abour_right.png" alt="img">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="about_offer_banner">
                        <a href="%21.html#"><img src="<?php echo base_url(); ?>assets/img/comon/small_banner.png" alt="img"></a>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="about_offer_banner">
                        <img src="<?php echo base_url(); ?>assets/img/comon/big_banner.png" alt="img">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="about_service_boxed">
                        <img src="<?php echo base_url(); ?>assets/img/icon/world.png" alt="img">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="about_service_boxed">
                        <img src="<?php echo base_url(); ?>assets/img/icon/walte.png" alt="img">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="about_service_boxed">
                        <img src="<?php echo base_url(); ?>assets/img/icon/star.png" alt="img">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="about_service_boxed">
                        <img src="<?php echo base_url(); ?>assets/img/icon/persentis.png" alt="img">
    ...
    <!-- consultation Area -->
    <section id="consultation_area" class="section_padding_bottom" style="background-image: url('<?php echo base_url(); ?>assets/img/comon/counter_bg.png');">
        <div class="container">
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 clo-sm-12 col-12">
                                <div class="counter_item">
                                    <img src="<?php echo base_url(); ?>assets/img/icon/user.png" alt="icon">
                            ...
                            <div class="col-lg-3 col-md-6 clo-sm-12 col-12">
                                <div class="counter_item">
                                    <img src="<?php echo base_url(); ?>assets/img/icon/bank.png" alt="icon">
                            ...
                            <div class="col-lg-3 col-md-6 clo-sm-12 col-12">
                                <div class="counter_item">
                                    <img src="<?php echo base_url(); ?>assets/img/icon/world-map.png" alt="icon">
                            ...
                            <div class="col-lg-3 col-md-6 clo-sm-12 col-12">
                                <div class="counter_item">
                                    <img src="<?php echo base_url(); ?>assets/img/icon/calander.png" alt="icon">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="all_review_box">
                        ...
                        <div class="all_review_text">
                            <img src="<?php echo base_url(); ?>assets/img/review/review6.png" alt="img">
                            <h4>Jesica simpsn</h4>
                            <span>Tourist</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="all_review_box">
                        ...
                        <div class="all_review_text">
                            <img src="<?php echo base_url(); ?>assets/img/review/review7.png" alt="img">
                            <h4>Jack cremer</h4>
                            <span>Manager</span>
                            <p>" Loved the overall tour for all 6 days covering jaipur jodhpur and jaisalmer. worth ur
                                money for sure. thanks. Driver was very good and polite and safe driving for all 6 days.
