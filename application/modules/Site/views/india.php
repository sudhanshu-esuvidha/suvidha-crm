                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="top_destinations_box img_hover">
                                ...
                                <a href="top-destinations-details.html"><img src="<?php echo base_url(); ?>assets/img/destination/main-page1.png"
                                        alt="img"></a>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="top_destinations_box img_hover">
                                ...
                                <a href="top-destinations-details.html"><img src="<?php echo base_url(); ?>assets/img/destination/main-page2.png"
                                        alt="img"></a>
                                <div class="top_destinations_box_content">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="top_destinations_box img_hover">
                                ...
                                <a href="top-destinations-details.html"><img src="<?php echo base_url(); ?>assets/img/destination/main-page3.png"
                                        alt="img"></a>
                                <div class="top_destinations_box_content">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="top_destinations_box img_hover">
                                ...
                                <a href="top-destinations-details.html"><img src="<?php echo base_url(); ?>assets/img/destination/main-page4.png"
                                        alt="img"></a>
                                <div class="top_destinations_box_content">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="top_destinations_box img_hover">
                                ...
                                <a href="top-destinations-details.html"><img src="<?php echo base_url(); ?>assets/img/destination/main-page5.png"
                                        alt="img"></a>
                                <div class="top_destinations_box_content">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="top_destinations_box img_hover">
                                ...
                                <a href="top-destinations-details.html"><img src="<?php echo base_url(); ?>assets/img/destination/main-page6.png"
                                        alt="img"></a>
                                <div class="top_destinations_box_content">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <div class="cta_left">
                        <div class="cta_icon">
                            <img src="<?php echo base_url(); ?>assets/img/common/email.png" alt="icon">
                        </div>
