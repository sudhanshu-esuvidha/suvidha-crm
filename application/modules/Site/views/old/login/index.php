...
<body class="">
	...
	<!--wrapper-->
	<div class="wrapper" style="background-image: url(<?php echo base_url(); ?>assets/images/bgimg.jpg);  background-repeat: repeat-y;">
							...
							<div class="card-body" >
								<div class="p-4">
									<div class="mb-3 text-center">
										...
										<img src="<?php echo base_url(); ?>assets/images/zplus-logo.jpg" style="width:100%; height: 60px;" alt="" /> 
										...
										<form class="row g-3" method="post">
											...
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input required type="password" class="form-control border-end-0" name="password"  placeholder="Enter Password"> <a href="<?php echo base_url(); ?>javascript:;" class="input-group-text bg-transparent"><i class='bx bx-hide'></i></a>
												</div>
											</div>
